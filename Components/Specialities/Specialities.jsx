...
const Specialities = () => {
    ...
    return (
        <div className=" mt-30 h-[90%] w-screen bg-gradient-to-br from-[#fff7fa] via-white to-pink-50 flex flex-col justify-center items-center px-4 md:px-8 relative overflow-hidden select-none">
            <div className="absolute top-[-10%] right-[-10%] w-[450px] h-[450px] bg-pink-200/20 rounded-full blur-[120px] pointer-events-none"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-[450px] h-[450px] bg-pink-100/30 rounded-full blur-[120px] pointer-events-none"></div>

            <div className="max-w-6xl w-full flex flex-col justify-between h-[75vh]">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-5xl font-serif text-[#5D1232] italic font-medium">
                        Special Bookings & <span className="text-pink-500 font-sans not-italic font-black">Celebrations</span>
                    </h2>
                    <p className="text-pink-900/60 text-xs md:text-sm font-semibold max-w-xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-auto items-center">
                    {services.map((item, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -8 }}
                            className="bg-white/80 backdrop-blur-xl border border-pink-100 rounded-[32px] p-6 relative flex flex-col justify-between h-[45vh] shadow-[0_15px_40px_rgba(93,18,50,0.04)] hover:shadow-[0_25px_50px_rgba(255,145,175,0.18)] hover:border-pink-200/80 transition-all duration-500 group"
                        >
                            <div>
                                ...
                                <p className="text-xs font-medium text-pink-900/60 mt-3 leading-relaxed line-clamp-3">
                                    {item.description}
                                </p>
                            </div>
                            ...
                            <div className="pt-4 border-t border-pink-100/60 flex items-center justify-between">
                                ...
                                <button className="w-10 h-10 bg-[#FFF0F3] text-[#5D1232] rounded-xl flex items-center justify-center hover:bg-[#5D1232] hover:text-white transition-all duration-300 shadow-sm group-hover:scale-105 active:scale-95">
                ...
                <motion.div
                    ...
                    className="flex justify-center items-center gap-3 text-xs font-black uppercase tracking-widest text-[#5D1232]"
                >
